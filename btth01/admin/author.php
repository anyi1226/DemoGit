                    ...
                    <tbody>
                       ...
                       if($result->num_rows > 0){
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>
                                    <a href='edit_category.php?id=1" . $row['ma_tgia'] . "' class='text-primary'><i class='fa-solid fa-pen-to-square'></i></a>
                                </td>";
                            // Thêm biểu tượng xóa với link
                            echo "<td>
                                    <a href='delete_category.php?id=1" . $row['ma_tgia'] . "' class='text-danger'><i class='fa-solid fa-trash'></i></a>
                                </td>";
                            echo "</tr>";
                        }
                        } else {
